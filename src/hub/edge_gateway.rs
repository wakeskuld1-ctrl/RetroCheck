...
mod tests {
    ...
    // ### 修改记录 (2026-03-15)
    // - 原因: DrainSignal 需要驱动排空标记
    // - 目的: 验证 set_draining 状态切换
    #[tokio::test]
    ...
    // ### 修改记录 (2026-03-15)
    // - 原因: DrainSignal 需要暴露 inflight 统计
    // - 目的: 验证 inflight_requests 与 guard 计数
    #[tokio::test]
...
pub struct EdgeGateway {
    ...
    // ### 修改记录 (2026-03-15)
    // - 原因: remove_hub 需要排空阶段拒绝新连接
    // - 目的: 用 draining 标识控制接入逻辑
    ...
    // ### 修改记录 (2026-03-15)
    // - 原因: DrainSignal 需要观测当前连接量
    // - 目的: 统计 inflight_requests 以判断排空完成
...
// ### 修改记录 (2026-03-15)
// - 原因: 需要自动维护 inflight 计数
// - 目的: 用 RAII 确保连接结束时计数回落
...
impl EdgeGateway {
    pub fn new(
        ...
        Ok(Self {
            ...
            // ### 修改记录 (2026-03-15)
            // - 原因: DrainSignal 需要判断是否仍有连接在途
            // - 目的: 提供 inflight_requests 的统计依据
            // ### 修改记录 (2026-03-15)
            // - 原因: 注释存在 ANSI 乱码
            // - 目的: 还原排空语义说明，避免误读
